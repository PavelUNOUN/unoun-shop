...
export default function FaqPage() {
  return (
    <>
      <PageHero
        eyebrow="FAQ"
        badge="Отдельная trust-страница"
        title="Частые вопросы перед покупкой и после получения"
        description="Здесь мы собрали ответы на самые частые вопросы о поверхностях, уходе, комплекте, доставке, оплате и гарантии. Это отдельная страница доверия, чтобы не перегружать лендинг длинными объяснениями."
