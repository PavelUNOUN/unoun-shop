      ...
      <section className="bg-zinc-50 py-16 md:py-20">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
          ...
          <InfoCard
            ...
            description="Обработка персональных данных строится по требованиям законодательства РФ и принципу разумной достаточности."
          >
      ...
      <section className="bg-zinc-50 py-16 md:py-20">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[1fr_0.95fr] lg:px-8">
          <InfoCard
            ...
            description="Перечень операций и передача третьим лицам ограничены целями оформления заказа, оплаты, доставки и сервисного сопровождения."
          >
            <div className="space-y-4">
              <div>
                <p className="text-sm font-semibold text-zinc-900">
