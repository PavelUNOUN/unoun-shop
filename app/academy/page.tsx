...
export const metadata: Metadata = {
  ...
  description:
    "Полезные статьи о применении паровой швабры дома, уходе за устройством и выборе аксессуаров.",
};
        ...
        <div className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 md:pb-20 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="font-heading text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl md:text-6xl">
              Статьи о применении и уходе
            </h1>
            <p className="mt-5 max-w-3xl text-sm leading-relaxed text-zinc-600 sm:text-base">
              В разделе собраны материалы о кухне, ванной, полу и текстиле, а
              также полезные статьи о выборе аксессуаров и уходе за устройством.
            </p>
          </div>
        </div>
      </section>
